...
5. [Реляционная алгебра без самостоятельного SQL](semester_5/practice_05_05_relational_algebra.md)
6. [Базовый SELECT](semester_5/practice_05_06_basic_select.md)
7. [DML-сценарии на основе SELECT](semester_5/practice_05_07_dml_select_scenarios.md)
8. [Контрольная 2: SELECT и DML](semester_5/practice_05_08_checkpoint_basic_sql.md)
9. [Минимальный DDL и ограничения](semester_5/practice_05_09_minimal_ddl_constraints.md)
...
14. [Безопасный SQL из приложения](semester_5/practice_05_14_sql_security.md)
...
2. [Устройство PostgreSQL-кластера и storage/MVCC-артефакты](semester_6/practice_06_02_cluster_internals.md)
