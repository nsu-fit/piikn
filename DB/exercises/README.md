...
- Файлы `provided/raw_derived_*.md` содержат дополнительные варианты, переработанные из сырьевых материалов рабочей группы. Они используются по назначению преподавателя и не всегда входят в обязательный студенческий шаблон.
...
Дополнительные банки вариантов сейчас подключены к `practice_05_05`, `practice_05_06`, `practice_05_09`, `practice_05_15` и `practice_06_05`.
