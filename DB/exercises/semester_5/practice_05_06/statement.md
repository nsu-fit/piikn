...
## Дополнительный банк задач

Файл `provided/raw_derived_sql_task_bank.md` содержит дополнительные SQL-задачи, адаптированные из сырьевых материалов рабочей группы под текущую демобазу `bookings`.

Блок S1 можно использовать как расширение этой практики после базового разбора `SELECT`, соединений и агрегатов. Блок S2 сложнее: он рассчитан на подзапросы, контрольную 5.8 или позднюю тренировку и не является обязательной частью базовой практики 5.6.
